作者：coderlang 34+ 程序员，CTO，全栈工程师，搬砖 11 年，薪资翻20倍，公众号 coderlang 主理人。
...
私钥通常由128位二进制数据组成，为了记住私钥，行业提出了众多解决方案，通过 BIP39 协议，将 128位二进制数据，转换为 12 个单词，即「助记词」，例如：```voice true main glow spare magic you snack dress summer cherry cash```就是一套助记词，你可以用它登录 dsyncle。
