...
私钥通常由128位二进制数据组成，为了方便你记住这一串数据，通过 BIP39 协议，将 128位二进制数据，转换为 12 个单词，即：助记词，比如，```voice true main glow spare magic you snack dress summer cherry cash```

公钥和私钥都是成对的，通过私钥可以导出公钥，它们有 2 个作用：**加密解密**和**签名验签**。
